...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'AppByDalin';
...
customersApp.controller('CustomersController', ['$scope', '$stateParams', 'Authentication', 'Customers', '$modal', '$log',
    function($scope, $stateParams, Authentication, Customers, $modal, $log) {
        ...
        // Part 1 **************************************************
        //open a modal window to Create a new customer record
        this.modalCreate = function (size) {
            ...
            var modalInstance = $modal.open({
                ...
                controller: ["$scope", "$modalInstance", function ($scope, $modalInstance) {
                    ...
                    $scope.ok = function () {  //close window only if require info is entered (surname)
                            $modalInstance.close();
                    };
        ...
        this.modalUpdate = function (size, selectedCustomer) {
            ...
            var modalInstance = $modal.open({
                ...
                controller: ["$scope", "$modalInstance", "customer", function ($scope, $modalInstance, customer) {
                    ...
                    //close window only if require info is entered (surname)
                    $scope.ok = function () {
